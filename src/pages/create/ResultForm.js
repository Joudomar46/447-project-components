...
export const ResultsForm = ({ onClick, keepoutPanels }) => {
  ...
  function handleSubmit(event) {
    ...
    resultsInfo.system_capacity =
      (+keepoutPanels.keepoutPanels * +resultsInfo.panelWattage) / 1000;
    onClick(resultsInfo);
  }
  ...
  return (
    <>
      <Box display="flex" justifyContent="center" alignItems="center">
        <h3>Enter the information bellow</h3>
      </Box>
      <Paper
        style={{
          padding: 50,
        ...
        >
          ...
          <Grid item xs="auto">
            ...
            <Button
              ...
              onClick={handleClick}
            >
              {resultsInfo.array_type === "0"
                ? "Fixed - Open Rack"
                : resultsInfo.array_type === "1"
                ? "Fixed - Roof Mounted"
                : "Open Menu"}
            </Button>
            <Menu
