...
export function DataFromAPI(keepoutPanels) {
  ...
  function handleSubmit(resultsInfo) {
  ...
  return (
    <>
      ...
      {showComponent ? (
        <Box display="inline-block" justifyContent="center" alignItems="center">
